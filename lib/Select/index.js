...
function (_DefineComponent) {
  ...
  _createClass(Select, [{
    ...
    value: function initValue() {
      _get(_getPrototypeOf(Select.prototype), "initValue", this).call(this);
    ...
    value: function loadOptions() {
      ...
      (0, _util.toPromise)(this.props.loadData, params).then(function (options) {
        ...
        _this2.initValueByOptions(options);
      });
    }
  }, {
    key: "initValueByOptions",
    value: function initValueByOptions() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.getOptions();
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_baseCom.AntSelect, _extends({
        ...
        className: (0, _util.classNames)('w-select', this.props.className),
        ref: this.setTarget
  ...
  _createClass(TreeSelect, [{
    ...
    value: function render() {
      return _react["default"].createElement(_baseCom.AntTreeSelect, _extends({}, (0, _util.getProps)(this), {
        ...
        className: (0, _util.classNames)('w-select', this.getProp('className'))
