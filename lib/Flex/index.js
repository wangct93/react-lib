  ...
  _createClass(Flex, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", _extends({}, (0, _utils.getDivProps)(props), {
        className: (0, _browserUtil.classNames)('w-flex', props.className, props.column && 'w-flex-column', props.verticalCenter && 'w-flex-vertical-center', props.center && 'w-flex-center', props.wrap && 'w-flex-wrap'),
        ref: props.divRef
      }), props.children);
    }
  }]);
...
function (_DefineComponent2) {
  ...
  _createClass(FlexItem, [{
    ...
    value: function render() {
      ...
      var extProps = props.flex ? {
        divRef: props.divRef
      } : {
        ref: props.divRef
      };
      return _react["default"].createElement(Com, _extends({}, (0, _utils.getDivProps)(props), extProps, {
        className: (0, _browserUtil.classNames)('w-flex-item', props.className)
      }), props.children);
    }
  }]);
