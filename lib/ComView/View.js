...
function (_DefineComponent3) {
  ...
  _createClass(Sider, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        className: (0, _browserUtil.classNames)('w-com-view-content-sider', this.state.fixed && 'w-com-view-content-sider-fixed')
      }, this.getOptions().map(function (opt, index) {
        return _react["default"].createElement(_tooltip["default"], {
          ...
          className: (0, _browserUtil.classNames)('w-com-view-content-sider-item', _this4.getValue() === index && 'active')
        }, opt.title));
      }));
    }
  }]);
